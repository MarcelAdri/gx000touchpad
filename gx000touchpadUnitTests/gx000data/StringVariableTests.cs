...
public class StringVariableTests
{
    ...
    public void SetUp()
    {
        ...
        _variable = new TestableStringVariable(VariableDefinitions.FirstMessageName, _testValue);
    }
    ...
    {
        // Act
        _variable.Value = "KlMnOpQrSt";
        var actualValue = _variable.Value;

        // Assert
        Assert.That(actualValue, Is.EqualTo("KlMnOpQrSt"));
    }
